#include "core/asset/loader/AudioLoader.h"

#include "index/AssetIndexBuilder.h"
#include "data/asset/source/AudioSource.h"
...
namespace resource
{
    ...
    bool AudioLoader::load(AudioSource& out, const AssetRecord& rec, std::string* outError)
    {
        out = AudioSource{};
